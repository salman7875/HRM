...
class AddEmployee extends Component {
  constructor() {
    ...
    this.state = {
      ...
      // teams and roels
      teamList: ['Team Salman', 'Team Rahul', 'Team Anand'],
      roleList: ['Full Stack Developer', 'Backend Developer', 'Frontend Developer', 'Devops', 'Android', 'IOS', 'Data engineer', 'Web designer'],
    };
  }
