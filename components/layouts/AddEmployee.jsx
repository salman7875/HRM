...
class AddEmployee extends Component {
  constructor() {
    ...
    this.state = {
      ...
      // teams and roels
      teamList: ['Team Salman', 'Team Rahul', 'Team Doctor'],
      roleList: ['Frontend', 'Backend', 'DevOps', 'Cloud Engineer', 'UI/UX', 'HR', 'Full-Stack Engineer', 'Android Developer', 'Web Developer'],
    };
  }
